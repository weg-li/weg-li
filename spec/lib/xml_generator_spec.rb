  ...
  %i[owi21 winowig].each do |template|
    it "handles the xml generation for #{template}" do
      travel_to("20.01.2020 15:00:00 UTC".to_time.utc) do
        ...
        notice = Fabricate.build(:notice, user:, charge:, brand: "märzer", color: "black", registration: "HH AB 123", city: "Dorf", street: "Am Weiher 123", zip: "17098", district:, token: "xxxxxxx")
        notice.save!
