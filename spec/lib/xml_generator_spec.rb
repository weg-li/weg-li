...
describe XMLGenerator do
  ...
  it "handles the xml generation" do
    travel_to('20.01.2020 15:00:00 UTC'.to_time.utc) do
      ...
      notice = Fabricate.build(:notice, user: user, charge: Charge::CHARGES[112474], brand: 'märzer', color: 'black', registration: 'HH AB 123', city: 'Dorf', street: 'Am Weiher 123', zip: '12345', district: district, token: 'xxxxxxx')
      notice.save!
