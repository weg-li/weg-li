...
describe PdfGenerator do
  ...
  it "handles the pdf generation" do
    travel_to("20.01.2020 15:00:00 UTC".to_time.utc) do
      ...
      user = Fabricate.build(:user, name: "Uschi Müller", email: "test@example.com", city: "바트 조덴", zip: "17098", street: "Am Weiher 123")
      ...
      file_fixture("anzeige.pdf").binwrite(result) if ENV["UPDATE_FIXTURES"].present?
